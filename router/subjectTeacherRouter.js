...
/**
 * @swagger
 * /api/v1/subjectTeacher/update-profile:
 *   put:
 *     tags:
 *       - SubjectTeacher
 *     summary: Update subject teacher profile
 *     description: Allows a subject teacher to update their profile including name, address, profile picture, and password.
 *     security:
 *       - bearerAuth: []
 *     requestBody:
 *       required: true
